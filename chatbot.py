...
from langchain_community.llms import Ollama  # Make sure to import the Ollama package
...
if prompt := st.chat_input("What is up?"):
    ...
    llm = Ollama(model="llama3")  # Replace with actual model name and initialization
